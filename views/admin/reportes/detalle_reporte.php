...
if (isset($_SESSION['documento'])) {
    ...
    if (isset($_GET['id'])) {
        ...
        $usua = $conectar->prepare("SELECT deta_reportes.*, herrramienta.*
                            ...
                            WHERE reportes.id_reporte = :reportes AND estado_reporte ='inactivo' 
 ");
...
<body class="main-layout in_page">
    ...
    <div class="container mt-3">
        ...
        <a href="lista_reportes_inactivos.php" class="btn btn-danger" style="margin-bottom: 10px;">Regresar</a>
    </div>
