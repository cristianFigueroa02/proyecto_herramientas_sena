...
$usua = $conectar->prepare("SELECT * FROM usuario 
...
<body class="main-layout in_page">
    ...
    <div class="container mt-3">
        <a href="crear_admin.php" class="btn btn-success mb-2">Crear una administrador</a>
            ...
            <tbody>
                ...
                <?php foreach ($asigna as $usua) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="editar_admin.php?id=<?= $usua["documento"] ?>" class="btn btn-primary ">Actualizar</a>
                            <a href="eliminar_admin.php?id=<?= $usua["documento"] ?>" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este administrador?')">Eliminar</a>
